...
public class SampleData {
  ...
  static void writeExampleData2(DatabaseClient dbClient, Singer Singers2) {
    List<Mutation> mutations = new ArrayList<>();
      mutations.add(
              Mutation.newInsertOrUpdateBuilder("Singers2")
                      .set("SingerId")
                      .to(Singers2.singerId)
                      .set("FirstName")
                      .to(Singers2.firstName)
                      .set("LastName")
                      .to(Singers2.lastName)
                      .set("LastUpdateTime")
                      .to(Value.COMMIT_TIMESTAMP)
                      .build());
